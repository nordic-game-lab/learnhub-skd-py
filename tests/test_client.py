...
from learnhub_sdk import LearnhubSdk, AsyncLearnhubSdk, APIResponseValidationError
from learnhub_sdk._models import BaseModel, FinalRequestOptions
from learnhub_sdk._constants import RAW_RESPONSE_HEADER
from learnhub_sdk._exceptions import APIStatusError, APITimeoutError, LearnhubSdkError, APIResponseValidationError
from learnhub_sdk._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: LearnhubSdk | AsyncLearnhubSdk) -> int:
...
class TestLearnhubSdk:
    client = LearnhubSdk(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "learnhub_sdk/_legacy_response.py",
                        "learnhub_sdk/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "learnhub_sdk/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(LearnhubSdkError):
            client2 = LearnhubSdk(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: LearnhubSdk) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(LEARNHUB_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = LearnhubSdk(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: LearnhubSdk) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: LearnhubSdk) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: LearnhubSdk) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = LearnhubSdk(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = LearnhubSdk(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("learnhub_sdk._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/v2/user").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.get("/v2/user", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}})
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/v2/user").mock(return_value=httpx.Response(500))
...
class TestAsyncLearnhubSdk:
    client = AsyncLearnhubSdk(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(LearnhubSdkError):
            client2 = AsyncLearnhubSdk(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncLearnhubSdk) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(LEARNHUB_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncLearnhubSdk(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncLearnhubSdk) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncLearnhubSdk) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncLearnhubSdk) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncLearnhubSdk(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncLearnhubSdk(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            await self.client.get(
                "/v2/user", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}}
            )
